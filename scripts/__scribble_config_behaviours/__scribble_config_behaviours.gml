...
#macro SCRIBBLE_AUTOFIT_INLINE_SPRITES        true  //Whether to automatically scale sprites to fit into the line of text. This is based on the font height of the current font
