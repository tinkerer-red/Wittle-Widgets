...
var _folder = new ControlPanelFolder("Folder 1", function(){log("Folder 1")})
	...
	var _folder2 = new ControlPanelFolder("Folder 2", function(){log("Folder 2")})
		...
		var _folder3 = new ControlPanelFolder("Folder 3", function(){log("Folder 2")})
			...
			var _dropdown1 = new ControlPanelDropdown("Dropdown 1", ["Option 1","Option 2","Option 3","Option 4","Option 5","Option 6","Option 7","Option 8","Option 9","Option 10","Option 11","Option 12","Option 13","Option 14","Option 15","Option 16","Option 17","Option 18","Option 19","Option 20"], function(_index, _element){log(["Dropdown", _index, _element])})
	...
	var _dropdown2 = new ControlPanelDropdown("Dropdown 2", ["Option 1","Option 2","Option 3","Option 4","Option 5","Option 6","Option 7","Option 8","Option 9","Option 10","Option 11","Option 12","Option 13","Option 14","Option 15","Option 16","Option 17","Option 18","Option 19","Option 20"], function(_index, _element){log(["Dropdown", _index, _element])})
...
var _folder4 = new ControlPanelFolder("Folder 4", function(){log("Folder 1")})
	...
	var _dropdown3 = new ControlPanelDropdown("Dropdown 3", ["Option 1","Option 2","Option 3","Option 4","Option 5","Option 6","Option 7","Option 8","Option 9","Option 10","Option 11","Option 12","Option 13","Option 14","Option 15","Option 16","Option 17","Option 18","Option 19","Option 20"], function(_index, _element){log(["Dropdown", _index, _element])})
